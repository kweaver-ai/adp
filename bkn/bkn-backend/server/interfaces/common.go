...
func GetBKNConceptSchemaDefinition(vectorDim int, defaultSmallModelEnabled bool) []*Property {
	...
	datasetProp := []*Property{
		...
		{
			Name:         "max_acceptable_level",
			Type:         data_type.DATATYPE_STRING,
			DisplayName:  "max_acceptable_level",
			OriginalName: "max_acceptable_level",
			Description:  "BKN风险类概念的最高可接受风险等级",
			Features: []PropertyFeature{
				{
					FeatureName: "keyword_max_acceptable_level",
					DisplayName: "keyword_max_acceptable_level",
					FeatureType: FieldFeatureType_Keyword,
					Description: "BKN风险类最高可接受等级的关键词特征",
					RefProperty: "max_acceptable_level",
					IsDefault:   true,
					IsNative:    false,
					Config:      map[string]any{FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE: FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE_VALUE},
				},
		...
		},
		{
			Name:         "risk_rules",
			Type:         data_type.DATATYPE_STRING,
			DisplayName:  "risk_rules",
			OriginalName: "risk_rules",
			Description:  "BKN风险类概念的风险规则JSON，需marshal成json string后存储",
			Features: []PropertyFeature{
				{
					FeatureName: "keyword_risk_rules",
					DisplayName: "keyword_risk_rules",
					FeatureType: FieldFeatureType_Keyword,
					Description: "BKN风险类风险规则的关键词特征",
					RefProperty: "risk_rules",
					IsDefault:   true,
					IsNative:    false,
					Config:      map[string]any{FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE: FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE_VALUE_8192},
				},
		...
		},
		{
			Name:         "risk_function",
			Type:         data_type.DATATYPE_STRING,
			DisplayName:  "risk_function",
			OriginalName: "risk_function",
			Description:  "BKN风险类概念的风险评估函数配置JSON，需marshal成json string后存储",
			Features: []PropertyFeature{
				{
					FeatureName: "keyword_risk_function",
					DisplayName: "keyword_risk_function",
					FeatureType: FieldFeatureType_Keyword,
					Description: "BKN风险类风险函数的关键词特征",
					RefProperty: "risk_function",
					IsDefault:   true,
					IsNative:    false,
					Config:      map[string]any{FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE: FIELD_KEYWORD_PROPERTY_IGNORE_ABOVE_VALUE_8192},
				},
