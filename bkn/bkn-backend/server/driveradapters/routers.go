...
func (r *restHandler) RegisterPublic(c *gin.Engine) {
	...
	for _, apiV1 := range []*gin.RouterGroup{bknApiV1, otlApiV1} {
		...
		apiV1.POST("/knowledge-networks/:kn_id/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateKNByEx)
		...
		apiV1.POST("/knowledge-networks/:kn_id/concept-groups/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateConceptGroupsByEx)
		...
		apiV1.POST("/knowledge-networks/:kn_id/object-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateObjectTypesByEx)
		...
		apiV1.POST("/knowledge-networks/:kn_id/relation-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateRelationTypesByEx)
		...
		apiV1.POST("/knowledge-networks/:kn_id/action-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateActionTypesByEx)
	...
	for _, apiInV1 := range []*gin.RouterGroup{bknApiInV1, otlApiInV1} {
		...
		apiInV1.POST("/knowledge-networks/:kn_id/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateKNByIn)
		...
		apiInV1.POST("/knowledge-networks/:kn_id/concept-groups/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateConceptGroupsByIn)
		...
		apiInV1.POST("/knowledge-networks/:kn_id/object-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateObjectTypesByIn)
		...
		apiInV1.POST("/knowledge-networks/:kn_id/relation-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateRelationTypesByIn)
		...
		apiInV1.POST("/knowledge-networks/:kn_id/action-types/validate", r.verifyJsonContentTypeMiddleWare(), r.ValidateActionTypesByIn)
