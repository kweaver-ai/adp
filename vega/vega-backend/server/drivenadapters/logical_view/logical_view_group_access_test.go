...
func Test_DataViewGroupAccess_CreateLogicalViewGroup(t *testing.T) {
	Convey("Test CreateLogicalViewGroup", t, func() {
		...
		Convey("Create failed, caused by the error from squirrel func ToSql", func() {
			...
			tx, _ := dvga.db.Begin()
			err := dvga.CreateLogicalViewGroup(testCtx, tx, group)
...
func Test_DataViewGroupAccess_DeleteDataViewsGroup(t *testing.T) {
	Convey("Test DeleteDataViewsGroup", t, func() {
		...
		Convey("Delete failed, caused by the error from squirrel func ToSql", func() {
			...
			tx, _ := dvga.db.Begin()
			err := dvga.DeleteLogicalViewGroup(testCtx, tx, "1")
			So(err, ShouldResemble, expectedErr)
...
func Test_DataViewGroupAccess_UpdateLogicalViewGroup(t *testing.T) {
	Convey("Test UpdateLogicalViewGroup", t, func() {
		appSetting := &common.AppSetting{}
		dvga, smock := MockNewDataViewGroupAccess(appSetting)
		...
		Convey("Update failed, caused by the error from squirrel func ToSql", func() {
			...
			err := dvga.UpdateLogicalViewGroup(testCtx, group)
			So(err, ShouldResemble, expectedErr)
...
func Test_DataViewGroupAccess_ListDataViewsGroup(t *testing.T) {
	Convey("Test ListDataViewsGroup", t, func() {
		...
		Convey("List failed, caused by the error from squirrel func ToSql", func() {
			...
			_, err := dvga.ListLogicalViewGroups(testCtx, listQuery)
			So(err, ShouldResemble, expectedErr)
		...
		Convey("List succeed with limit is equal to 1", func() {
			...
			entries, err := dvga.ListLogicalViewGroups(testCtx, listQuery)
			So(err, ShouldBeNil)
...
func Test_DataViewGroupAccess_GetLogicalViewGroupsTotal(t *testing.T) {
	Convey("Test GetLogicalViewGroupsTotal", t, func() {
		appSetting := &common.AppSetting{}
		dvga, smock := MockNewDataViewGroupAccess(appSetting)
		...
		Convey("Get failed, caused by the error from squirrel func ToSql", func() {
			...
			total, err := dvga.GetLogicalViewGroupsTotal(testCtx, listQuery)
...
func Test_DataViewGroupAccess_GetLogicalViewGroupByID(t *testing.T) {
	Convey("Test GetLogicalViewGroupByID", t, func() {
		appSetting := &common.AppSetting{}
		dvga, smock := MockNewDataViewGroupAccess(appSetting)
		...
		Convey("Get failed, caused by the error from squirrel func ToSql", func() {
			...
			_, _, err := dvga.GetLogicalViewGroupByID(testCtx, group.GroupID)
			So(err, ShouldResemble, expectedErr)
		...
		Convey("Get failed, caused by ErrNoRows", func() {
			...
			_, exist, err := dvga.GetLogicalViewGroupByID(testCtx, group.GroupID)
...
func Test_DataViewGroupAccess_CheckLogicalViewGroupExistByName(t *testing.T) {
	Convey("Test CheckLogicalViewGroupExistByName", t, func() {
		appSetting := &common.AppSetting{}
		dvga, smock := MockNewDataViewGroupAccess(appSetting)
		...
		Convey("Check failed, caused by the error from squirrel func ToSql", func() {
			...
			_, _, err := dvga.CheckLogicalViewGroupExistByName(testCtx, nil, group.GroupName, group.Builtin)
			So(err, ShouldResemble, expectedErr)
		...
		Convey("Get failed, caused by ErrNoRows", func() {
			...
			_, exist, err := dvga.CheckLogicalViewGroupExistByName(testCtx, nil, group.GroupName, group.Builtin)
			So(exist, ShouldBeFalse)
			So(err, ShouldBeNil)
