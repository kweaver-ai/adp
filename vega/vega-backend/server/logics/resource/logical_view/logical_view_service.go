...
var (
	...
	dvService     interfaces.LogicalViewService
)
...
func (dvs *dataViewService) CreateLogicalViews(ctx context.Context, views []*interfaces.DataView, mode string, checkPermission bool) ([]string, error) {
...
func (dvs *dataViewService) DeleteDataViews(ctx context.Context, viewIDs []string) error {
	...
	// 删除数据视图表中的视图
	err = dvs.dva.DeleteLogicalViews(ctx, tx, viewIDs)
	if err != nil {
		needRollback = true
