...
CREATE TABLE IF NOT EXISTS "t_flow_dag" (
 ...
 "f_user_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_name" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_desc" TEXT DEFAULT NULL,
 "f_trigger" TEXT DEFAULT NULL,
 "f_cron" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 ...
 "f_type" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_policy_type" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_appinfo" TEXT DEFAULT NULL,
 "f_priority" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_removed" TINYINT NOT NULL DEFAULT 0,
 "f_emails" TEXT DEFAULT NULL,
 "f_template" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_published" TINYINT NOT NULL DEFAULT 0,
 "f_trigger_config" TEXT DEFAULT NULL,
 "f_sub_ids" TEXT DEFAULT NULL,
 "f_exec_mode" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_category" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_outputs" TEXT DEFAULT NULL,
 "f_instructions" TEXT DEFAULT NULL,
 "f_operator_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_inc_values" TEXT DEFAULT NULL,
 "f_version" TEXT DEFAULT NULL,
 "f_version_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_modify_by" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_is_debug" TINYINT NOT NULL DEFAULT 0,
 "f_debug_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_biz_domain_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS "t_flow_dag_var" (
 ...
 "f_var_type" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS "t_flow_dag_step" (
 ...
 "f_source_id" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS "t_flow_dag_version" (
 ...
 "f_version_id" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_change_log" TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "t_flow_dag_instance" (
 ...
 "f_dag_id" BIGINT NOT NULL DEFAULT 0,
 "f_trigger" TEXT DEFAULT NULL,
 "f_worker" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_source" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_vars" TEXT DEFAULT NULL,
 "f_keywords" TEXT DEFAULT NULL,
 "f_event_persistence" INT NOT NULL DEFAULT 0,
 ...
 "f_dag_type" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_policy_type" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_appinfo" TEXT DEFAULT NULL,
 "f_priority" VARCHAR(64 CHAR) NOT NULL DEFAULT '',
 "f_mode" INT NOT NULL DEFAULT 0,
 "f_dump" TEXT DEFAULT NULL,
 "f_dump_ext" TEXT DEFAULT NULL,
 "f_success_callback" TEXT DEFAULT NULL,
 "f_error_callback" TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "t_flow_inbox" (
 ...
 "f_topic" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_docid" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS "t_flow_client" (
 ...
 "f_created_at" BIGINT NOT NULL DEFAULT 0,
 "f_updated_at" BIGINT NOT NULL DEFAULT 0,
 "f_client_name" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_client_id" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
 "f_client_secret" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
  CLUSTER PRIMARY KEY ("f_id")
);
...
CREATE TABLE IF NOT EXISTS "t_flow_log" (
 ...
 "f_key" VARCHAR(255 CHAR) NOT NULL DEFAULT '',
