...
CREATE TABLE IF NOT EXISTS `t_dag` (
 ...
 `f_user_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '用户ID',
 `f_name` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'DAG名称',
 `f_desc` LONGTEXT DEFAULT NULL COMMENT 'DAG描述',
 `f_trigger` LONGTEXT DEFAULT NULL COMMENT '触发器配置',
 `f_cron` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Cron表达式',
 `f_vars` LONGTEXT DEFAULT NULL COMMENT '变量定义',
 `f_status` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '状态',
 `f_tasks` LONGTEXT DEFAULT NULL COMMENT '任务配置',
 `f_steps` LONGTEXT DEFAULT NULL COMMENT '步骤配置',
 `f_description` LONGTEXT DEFAULT NULL COMMENT '详细描述',
 `f_shortcuts` LONGTEXT DEFAULT NULL COMMENT '快捷配置',
 `f_accessors` LONGTEXT DEFAULT NULL COMMENT '访问者列表',
 `f_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'DAG类型',
 `f_policy_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '策略类型',
 `f_appinfo` LONGTEXT DEFAULT NULL COMMENT '应用信息',
 `f_priority` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '优先级',
 `f_removed` BOOLEAN NOT NULL DEFAULT 0 COMMENT '删除标记',
 `f_emails` LONGTEXT DEFAULT NULL COMMENT '通知邮箱',
 `f_template` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '模板标识',
 `f_published` BOOLEAN NOT NULL DEFAULT 0 COMMENT '发布标记',
 `f_trigger_config` LONGTEXT DEFAULT NULL COMMENT '触发器配置详情',
 `f_sub_ids` LONGTEXT DEFAULT NULL COMMENT '子ID列表',
 `f_exec_mode` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '执行模式',
 `f_category` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '分类',
 `f_outputs` LONGTEXT DEFAULT NULL COMMENT '输出定义',
 `f_instructions` LONGTEXT DEFAULT NULL COMMENT '操作说明',
 `f_operator_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '操作人ID',
 `f_inc_values` LONGTEXT DEFAULT NULL COMMENT '增量值',
 `f_version` LONGTEXT DEFAULT NULL COMMENT '版本信息',
 `f_version_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '版本ID',
 `f_modify_by` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '修改人',
 `f_is_debug` BOOLEAN NOT NULL DEFAULT 0 COMMENT '调试标记',
 `f_debug_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '调试ID',
...
CREATE TABLE IF NOT EXISTS `t_dag_vars` (
 ...
 `f_var_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '变量类型',
...
CREATE TABLE IF NOT EXISTS `t_dag_step` (
 ...
 `f_source_id` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '来源ID',
 `f_has_datasource` BOOLEAN NOT NULL DEFAULT 0 COMMENT '是否有数据源',
  PRIMARY KEY (`f_id`),
  KEY `idx_dag_step_op_src_dag` (`f_source_id`, `f_operator`, `f_dag_id`),
...
CREATE TABLE IF NOT EXISTS `t_dag_versions` (
 ...
 `f_created_at` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间',
 `f_updated_at` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间',
 `f_dag_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'DAG ID',
 `f_user_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '用户ID',
 `f_version` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '版本号',
 `f_version_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '版本ID',
 `f_change_log` TEXT DEFAULT NULL COMMENT '变更记录',
...
CREATE TABLE IF NOT EXISTS `t_dag_instance` (
 ...
 `f_dag_id` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'DAG ID',
 `f_trigger` LONGTEXT DEFAULT NULL COMMENT '触发器配置',
 `f_worker` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '执行节点',
 `f_source` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '来源',
 `f_vars` LONGTEXT DEFAULT NULL COMMENT '变量',
 `f_keywords` LONGTEXT DEFAULT NULL COMMENT '关键词',
 `f_event_persistence` INT NOT NULL DEFAULT 0 COMMENT '事件持久化标记',
 `f_event_oss_path` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '事件OSS路径',
 `f_share_data` LONGTEXT DEFAULT NULL COMMENT '共享数据',
 `f_share_data_ext` LONGTEXT DEFAULT NULL COMMENT '共享数据扩展',
 `f_status` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '状态',
 `f_reason` LONGTEXT DEFAULT NULL COMMENT '原因',
 `f_cmd` LONGTEXT DEFAULT NULL COMMENT '命令',
 `f_has_cmd` BOOLEAN NOT NULL DEFAULT 0 COMMENT '是否包含命令',
 `f_batch_run_id` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '批次运行ID',
 `f_user_id` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '用户ID',
 `f_ended_at` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '结束时间',
 `f_dag_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'DAG类型',
 `f_policy_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '策略类型',
 `f_appinfo` LONGTEXT DEFAULT NULL COMMENT '应用信息',
 `f_priority` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '优先级',
 `f_mode` INT NOT NULL DEFAULT 0 COMMENT '模式',
 `f_dump` LONGTEXT DEFAULT NULL COMMENT 'Dump数据',
 `f_dump_ext` LONGTEXT DEFAULT NULL COMMENT 'Dump扩展',
 `f_success_callback` LONGTEXT DEFAULT NULL COMMENT '成功回调',
 `f_error_callback` LONGTEXT DEFAULT NULL COMMENT '失败回调',
 `f_call_chain` LONGTEXT DEFAULT NULL COMMENT '调用链',
 `f_resume_data` LONGTEXT DEFAULT NULL COMMENT '恢复数据',
...
CREATE TABLE IF NOT EXISTS `t_inbox` (
 ...
 `f_created_at` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间',
 `f_updated_at` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间',
 `f_msg` LONGTEXT DEFAULT NULL COMMENT '消息内容',
 `f_topic` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '主题',
 `f_docid` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '文档ID',
...
CREATE TABLE IF NOT EXISTS `t_task_instance` (
 ...
 `f_status` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '状态',
 `f_reason` LONGTEXT DEFAULT NULL COMMENT '原因',
 `f_pre_checks` LONGTEXT DEFAULT NULL COMMENT '预检查',
 `f_results` LONGTEXT DEFAULT NULL COMMENT '结果',
 `f_steps` LONGTEXT DEFAULT NULL COMMENT '步骤',
...
CREATE TABLE IF NOT EXISTS `t_client` (
 ...
 `f_created_at` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间',
 `f_updated_at` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间',
 `f_client_name` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '客户端名称',
 `f_client_id` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '客户端ID',
...
CREATE TABLE IF NOT EXISTS `t_log` (
 ...
 `f_key` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'OSS Key',
