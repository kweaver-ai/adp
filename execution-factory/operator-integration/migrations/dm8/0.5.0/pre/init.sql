...
CREATE TABLE IF NOT EXISTS "t_skill_file_index" (
    ...
    "f_storage_key" VARCHAR(1024 CHAR) NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS t_skill_file_index_uk_skill_rel_path ON t_skill_file_index(f_skill_id, f_rel_path);
CREATE UNIQUE INDEX IF NOT EXISTS t_skill_file_index_uk_skill_path_hash ON t_skill_file_index(f_skill_id, f_path_hash);
CREATE INDEX IF NOT EXISTS t_skill_file_index_idx_skill_id_update_time ON t_skill_file_index(f_skill_id, f_update_time);
